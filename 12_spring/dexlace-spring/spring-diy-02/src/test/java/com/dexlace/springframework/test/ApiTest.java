...
public class ApiTest {
    ...
    public void test_BeanFactory() {
        ...
        // 4.获取bean
        UserService userService = (UserService) beanFactory.getBean("userService", "乌克兰");
    ...
    public void test_cglib() {
        ...
        Object obj = enhancer.create(new Class[]{String.class}, new Object[]{"俄罗斯"});
    ...
    public void test_constructor() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        UserService userService = declaredConstructor.newInstance("美国");
        System.out.println(userService);
    }
    ...
    public void test_parameterTypes() throws Exception {
        ...
        // 创建实例
        UserService userService = declaredConstructor.newInstance("沙特");
        System.out.println(userService);
    }
